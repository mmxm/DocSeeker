        ...
        NavigationStack {
            Form {
                ...
                Section("Réseau & Synchronisation") {
                    HStack {
                        Label("Statut réseau", systemImage: network.isConnected ? "wifi" : "wifi.slash")
                        Spacer()
                        Text(network.isConnected ? "En ligne" : "Hors-ligne")
                            .foregroundColor(network.isConnected ? .green : .orange)
                    }
                }
